-- drop procedure sigpromj_sp_insert_token;
delimiter //
CREATE PROCEDURE sigpromj_sp_update_password
( 
...
begin
	...
	if sql_error = false then
		...
		UPDATE sigpromj_users_login_info
...
-- call sigpromj_sp_update_password('$2y$10$q9gIxLqcSezkGu.or8bjPu60v14kMxjtqBYZnB1JXElrWWDCUi1i2',1);