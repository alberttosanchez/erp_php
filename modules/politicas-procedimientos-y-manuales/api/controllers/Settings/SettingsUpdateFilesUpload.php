<?php // target : settings-update_files_upload
...
// obtenemos un array
$obj_file_upload_options = isset( $jsonObject->file_upload_options ) ? json_decode(trim_double($jsonObject->file_upload_options)) : json_decode("{}");

//var_dump($obj_file_upload_options);
...
$obj_old_json_options->uploads->allow             = $obj_file_upload_options->allow;
$obj_old_json_options->uploads->filter            = $obj_file_upload_options->filter;
$obj_old_json_options->uploads->slug_allowed      = $obj_file_upload_options->slug_allowed;
$obj_old_json_options->uploads->file_extensions   = $obj_file_upload_options->file_extensions;
