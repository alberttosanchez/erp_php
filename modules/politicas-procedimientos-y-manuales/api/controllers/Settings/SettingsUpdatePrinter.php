<?php // target : settings-update_printer
...
// obtenemos un array
$obj_printer_options = isset( $jsonObject->printer_options ) ? json_decode(trim_double($jsonObject->printer_options)) : json_decode("{}");

//var_dump($obj_printer_options);
...
$obj_old_json_options->printer->allow = $obj_printer_options->print_allow;
...
$option_applied = ($obj_printer_options->print_allow == true) ? "true" : "false";

$array_new_post_data = [
    'user_id'            => $user_id,
    'log_description'    => "El usuario id: $user_id, cambia opcion de impresion a: $option_applied",
    'root'               => "modulo: " . ARCH_MODULE_NAME . ", Opciones de impresion."
];
