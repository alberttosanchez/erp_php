<?php // target : post-read_all

/** Procedemos a obtener el atributo para filtrar los post a mostrar del objeto json */

$post_filter = isset($jsonObject->filter) ? cleanData(trim_double($jsonObject->filter)) : ""; 

$has_filter = ($post_filter == "all") ? false : true;

/** verificamos que el filter de post exista o devuelve faltan parametros */

if ( !isset($post_filter) || empty($post_filter) || $post_filter  == "" )
{
