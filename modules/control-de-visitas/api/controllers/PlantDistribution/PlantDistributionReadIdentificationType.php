<?php // target: plant_distribution-read_identificationtype
    ...
    $result = $ManageDB->get_table_rows(
        $table_name = 'cvcat_identification_type',
        $filter = "",
        $keyword = "",            
        $limit = 1000,
        $selected_page = '1',
    ...
    if ( ! isset($result['fetched']) || count($result['fetched']) < 1 || !isset($result['fetched'][0]['identification_type']) )
    {
