<?php // plant_distribution-read_searchfilters
    ...
    $result = $ManageDB->get_table_rows(
        $table_name = 'cvcat_plant_dist_filter',
        $filter = "",
        $keyword = "",            
        $limit = 1000,
        $selected_page = '1',
    ...
    if ( ! isset($result['fetched']) || count($result['fetched']) < 1 || !isset($result['fetched'][0]['filter_name']) )
    {
