<?php // target: plant_distribution-read_levelaccess
    ...
    if ( ! isset($result['fetched']) || count($result['fetched']) < 1 || !isset($result['fetched'][0]['level_access']) )
    {
