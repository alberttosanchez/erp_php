<?php // target: categories-read_visitreason
    ...
    if ( ! isset($result['fetched']) || count($result['fetched']) < 1 || !isset($result['fetched'][0]['reason_of_visit']) )
    {
